...
export default function Footer() {
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-white">Citizen</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-white">Garbage Collector</a>
        </p>
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-white">F.A.Q</a>
        </p>
        <p className="mb-4">
  ...
  <div className="text-center p-6 bg-teal-900">
    ...
    <a className="text-white font-semibold" href="https://tailwind-elements.com/">Waste-Setu</a>
  </div>
</footer>
    </div>
  )
